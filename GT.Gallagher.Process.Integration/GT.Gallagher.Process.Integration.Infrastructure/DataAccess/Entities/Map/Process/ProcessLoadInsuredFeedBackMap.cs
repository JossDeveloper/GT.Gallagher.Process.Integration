...
public class ProcessLoadInsuredFeedBackMap : IEntityTypeConfiguration<ProcessLoadInsuredFeedBack>
{
    public void Configure(EntityTypeBuilder<ProcessLoadInsuredFeedBack> builder)
    {
