...
public class GetScheduledProcessHandler : Handler<ProcessLoadMovementRequest>
{
    ...
    public override async Task ProcessRequest(ProcessLoadMovementRequest request)
    {
        ...
        request.ScheduledProcesses = commonRepository.GetScheduledProcesses(Guid.Parse(Environment.GetEnvironmentVariable("CODE_SCHEDULED_MOVEMENT")), 0);
