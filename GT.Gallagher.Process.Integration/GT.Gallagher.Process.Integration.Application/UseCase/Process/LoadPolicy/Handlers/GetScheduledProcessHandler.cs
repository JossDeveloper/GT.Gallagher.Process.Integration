...
public class GetScheduledProcessHandler : Handler<ProcessLoadPolicyRequest>
{
    ...
    public override async Task ProcessRequest(ProcessLoadPolicyRequest request)
    {
        ...
        request.ScheduledProcesses = commonRepository.GetScheduledProcesses(Guid.Parse(Environment.GetEnvironmentVariable("CODE_SCHEDULED_POLICY")), 0);
