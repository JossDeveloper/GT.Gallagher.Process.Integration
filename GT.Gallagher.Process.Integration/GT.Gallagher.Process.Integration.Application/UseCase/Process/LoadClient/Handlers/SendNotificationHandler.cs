...
public class SendNotificationHandler : Handler<ProcessLoadClientRequest>
{
    ...
    private readonly IProcessLoadClientRepository processLoadClientRepository;

    public SendNotificationHandler(ITPAServiceTokenRepository tokenRepository, INotificationEndProcessRepository notificationRepository, IProcessLoadClientRepository processLoadClientRepository)
    {
        this.tokenRepository = tokenRepository;
        this.notificationRepository = notificationRepository;
        this.processLoadClientRepository = processLoadClientRepository;
    }
    ...
    public override async Task ProcessRequest(ProcessLoadClientRequest request)
    {
        ...
        byte[] excelAttach = processLoadClientRepository.GenerateExcelToAttach(request.MasterDetailsFeedBack);
        ...
        var codeNotification = Environment.GetEnvironmentVariable("CODE_NOTIFICATION_CLIENT");
        ...
        if (Guid.TryParse(codeNotification, out Guid code))
        {
            ...
            processLoadClientRepository.PutSftpFilesHistory(request.RepositoryServer, request.FeedBack, excelAttach);
            request.StepRecords.LastOrDefault().OutputJson = "Successful generation.";
