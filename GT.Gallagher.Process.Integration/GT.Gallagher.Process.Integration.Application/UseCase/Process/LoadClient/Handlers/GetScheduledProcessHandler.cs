...
public class GetScheduledProcessHandler : Handler<ProcessLoadClientRequest>
{
    ...
    public override async Task ProcessRequest(ProcessLoadClientRequest request)
    {
        ...
        request.ScheduledProcesses = commonRepository.GetScheduledProcesses(Guid.Parse(Environment.GetEnvironmentVariable("CODE_SCHEDULED_CLIENT")), 0);
