...
public class ProcessLoadInstallmentResponse
{
    ...
    public ProcessLoadInstallmentResponse(string codResponse, string txtResponse, List<ProblemDetail> details, ProcessLoadOutput? output)
    {
