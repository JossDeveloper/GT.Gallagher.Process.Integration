...
public class SendNotificationHandler : Handler<ProcessLoadInstallmentRequest>
{
    ...
    private readonly IProcessLoadInstallmentRepository processLoadInstallmentRepository;

    public SendNotificationHandler(ITPAServiceTokenRepository tokenRepository, INotificationEndProcessRepository notificationRepository, IProcessLoadInstallmentRepository processLoadInstallmentRepository)
    {
        this.tokenRepository = tokenRepository;
        this.notificationRepository = notificationRepository;
        this.processLoadInstallmentRepository = processLoadInstallmentRepository;
    }
    ...
    public override async Task ProcessRequest(ProcessLoadInstallmentRequest request)
    {
        ...
        byte[] excelAttach = processLoadInstallmentRepository.GenerateExcelToAttach(request.MasterDetailsFeedBack);
        ...
        var codeNotification = Environment.GetEnvironmentVariable("CODE_NOTIFICATION_INSTALLMENT");
        ...
        if (Guid.TryParse(codeNotification, out Guid code))
        {
            ...
            processLoadInstallmentRepository.PutSftpFilesHistory(request.RepositoryServer, request.FeedBack, excelAttach);
            request.StepRecords.LastOrDefault().OutputJson = "Successful generation.";
