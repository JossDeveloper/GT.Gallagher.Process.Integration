...
public class GetScheduledProcessHandler : Handler<ProcessLoadVehicleRequest>
{
    ...
    public override async Task ProcessRequest(ProcessLoadVehicleRequest request)
    {
        ...
        request.ScheduledProcesses = commonRepository.GetScheduledProcesses(Guid.Parse(Environment.GetEnvironmentVariable("CODE_SCHEDULED_VEHICLE")), 0);
