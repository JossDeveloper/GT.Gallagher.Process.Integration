...
public class GetScheduledProcessHandler : Handler<ProcessLoadInsuredRequest>
{
    ...
    public override async Task ProcessRequest(ProcessLoadInsuredRequest request)
    {
        ...
        request.ScheduledProcesses = commonRepository.GetScheduledProcesses(Guid.Parse(Environment.GetEnvironmentVariable("CODE_SCHEDULED_INSURED")), 0);
