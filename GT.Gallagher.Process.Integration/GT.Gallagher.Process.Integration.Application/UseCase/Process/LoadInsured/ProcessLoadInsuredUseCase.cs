...
using GT.Gallagher.Process.Integration.Application.UseCase.Process.LoadInsured.Handlers;
...
public class ProcessLoadInsuredUseCase : IProcessLoadInsuredUseCase
{
    private readonly ValidateDataInputHandler validateDataInputHandler;
    private readonly IOutputPort<ProcessLoadInsuredResponse> outputPort;
    private readonly IRecordRepository recordRepository;

    public ProcessLoadInsuredUseCase(ValidateDataInputHandler validateDataInputHandler, 
        ...
        IOutputPort<ProcessLoadInsuredResponse> outputPort, 
    ...
    public async Task Execute(ProcessLoadInsuredRequest request)
    {
        try
        {
            ...
            {
                outputPort.Standard(new ProcessLoadInsuredResponse(
                    request.CodResponse,
                    request.TxtResponse,
                    request.Details,
                    request.Output));
