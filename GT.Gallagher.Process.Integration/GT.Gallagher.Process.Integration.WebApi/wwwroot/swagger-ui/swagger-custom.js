(function () {
    ...
    link.href = '../swagger-ui/resources/favicon.ico';
...
(function () {
    window.addEventListener("load", function () {
        setTimeout(function () {
            ...
            logo[0].href = "https://qa.globaltpa.net.pe/gallagher";
            logo[0].target = "_blank";

            // Section 02 - Set logo
            logo[0].children[0].alt = "Gallagher";
            logo[0].children[0].src = "../swagger-ui/resources/gallagher-logo.jpg";
